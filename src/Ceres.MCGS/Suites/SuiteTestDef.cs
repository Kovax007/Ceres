...
namespace Ceres.MCGS.Features.Suites
{
  ...
  public class SuiteTestDef
  {
    ...
    public GameEngineDefCeresMCGS Engine1Def => CeresEngine1Def.EngineDef as GameEngineDefCeresMCGS;
    public GameEngineDefCeresMCGS Engine2Def => CeresEngine2Def?.EngineDef as GameEngineDefCeresMCGS;

    public GameEngineDefLC0 EngineLc0Def => ExternalEngineDef.EngineDef as GameEngineDefLC0;
    ...
    {
      if (ceresEngine2Def != null && (ceresEngine2Def.EngineDef is not GameEngineDefCeresMCGS))
      {
        throw new Exception("ceresEngine2Def is expected to be for a Ceres engine");
      }

      if (externalEngineDef != null && (externalEngineDef.EngineDef is GameEngineDefCeresMCGS))
      {
